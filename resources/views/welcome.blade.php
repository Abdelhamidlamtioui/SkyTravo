                                  ...
                                  <div class="dropdowns">
                                      <div class="selections">
                                          <i class="fa-solid fa-basket-shopping text-muted me-2"></i><span
                                              class="selected">Select Flight Type</span>
                                          <div class="caret"></div>
                                      </div>
                                      <ul class="menu">
                                          @foreach($flightsTypes as $flightType)
                                          <li>{{ $flightType->name }}</li> <!-- Adjust according to your Flighttype model -->
                                          @endforeach
                                      </ul>
                                  </div>
                              </div>
          ...
          <div class="col-xl-3 col-lg-4 col-md-4 col-sm-6">
            <div class="destination-blocks bg-white p-2 rounded border br-dashed h-100">
              <div class="destination-blocks-pics p-1">
                <a href="#"><img src="{{ $airport->getFirstMediaUrl('AirportImage') }}" class="img-fluid rounded" alt=""></a>
              </div>
              ...
              <a href="#" class="card rounded-3 shadow-wrap h-100 m-0">
                <div class="flight-thumb-wrapper">
                  ...
                  <div class="popFlights-item-overHidden">
                    <img src="{{ asset('image')}}/{{$flight->rel_to_airport_destination_airport_id->image }}" class="img-fluid" alt="">
                  </div>
                </div>
                <div class="touritem-middle position-relative p-3">
                  <div class="touritem-flexxer">
                    <h4 class="city fs-6 m-0 fw-bold">
                      <span>{{$flight->rel_to_airport_origin_airport_id->name}}</span>
                      ...
                      <span>{{$flight->rel_to_airport_destination_airport_id->name}}</span>
                    </h4>
                  ...
                  <div class="flight-foots">
                    <h5 class="fs-5 low-price m-0"><span class="tag-span">From</span> <span class="price">US${{floor($flight->economy_price)}}</span>
                    </h5>
                  </div>
                </div>
              </a>
