    ...
    <div class="card">
      ...
      <div class="card-body"> 
        ...
        <form action="{{route('admin.nationality.store')}}" method="POST" > 
          ...
          <div class="mt-3">
            <button type="submit" class="btn btn-info">Add Nationality</button>
          </div>
        </form>
      </div>
    </div>
          ...
          <tbody> 
            @foreach ($nationalities as $national ) 
              <tr>
                ...
                <form action="{{ route('admin.nationality.destroy', $national->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Airport?');">
                  @csrf
                  @method('DELETE')
