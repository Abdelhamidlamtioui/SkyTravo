                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarEcommerce">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{route('airlinemanager.flight.create')}}">Add Flights</a>
                                    </li>
                                    <li>
                                        <a href="{{route('airlinemanager.flight.index')}}">Flights List</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li class="side-nav-item">
                            <a href="{{route('airlinemanager.booking.index')}}" class="side-nav-link">
